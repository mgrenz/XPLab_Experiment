...
**QUESTION: When using the models, HOWMANY and COMP are never listed as Coefficients !!!**
``` {r model 1}
# main effect
# entire dataset
fm1 <- clmm(
...
**QUESTION: Error in subset function ?!?! values stay the same for every subset**
